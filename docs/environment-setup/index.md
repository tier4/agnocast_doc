...
sudo apt install \
  agnocast-kmod-v2.3.5 \
  agnocast-heaphook-v2.3.5
```
...
!!! note "Versioning rules"
    ...
    Packages use version-pinned names (e.g., `agnocast-kmod-v2.3.5`) to ensure all components are at exactly the same version.
